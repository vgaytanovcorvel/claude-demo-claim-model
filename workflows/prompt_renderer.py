...
class WorkflowPromptRenderer:
    ...
    def render(spec: WorkflowSpec) -> str:
        ...
        parts.append(
            ...
            "- terminate_todo_item: Terminate an open item by its ID. "
            "Provide todo_item_id and reason ('closed' when work is done, "
            "'cancelled' when work is no longer needed).\n"
            ...
            "All open items linked to this entity via context_entity_id "
            "are automatically cancelled — you do NOT need to cancel them separately.\n"
